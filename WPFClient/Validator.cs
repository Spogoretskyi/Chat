...
namespace WPFClient
{
    class Validator : IDataErrorInfo
    {
            ...
            get
            {
                ...
                switch (columnName)
                {
                    case "Phone":
                        ...
                        {
                            if (!Char.IsDigit(Phone[i])) error = "Please enter the digits";
                        }
                    ...
                    case "Registration_Code":
                    {
                        ...
                        {
                            if (!Char.IsDigit(Registration_Code[i])) error = "Please enter 4 digits";
                        }
                    }
                        break;
                    default:
        ...
        {
            if (!Regex.IsMatch(Mail, pattern)) return false;
            return true;
        }
    }
}
